...
import LandingSection2 from "./LandingHero"
...
const Landing = () => {
    ...
    return (
        <>
            <div className="w-full min-h-[clamp(600px,calc(100svh-64px),760px)]">

                {/* Landing Page Header - Section-1 */}
                <LandingHeader />
                <div className="mx-8 flex -mt-7.5 justify-center" >
                    

                    {/* Landing: Section-1 */}
                    <div className="flex w-full shrink-0 flex-col items-center px-4  sm:px-2 sm:pt-24 md:px-8 md:pt-32 lg:pt-36 ">
                        <motion.p
